...
<pre><code>describe 'PATCH #update_image' do
...
<pre><code>factory :user_image, class: 'User' do
...
<pre><code>guard :rspec, cmd: 'spring rspec -f progress', all_on_start: false, all_after_pass: false do
