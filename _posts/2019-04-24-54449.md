...
<pre><code>export N_PREFIX="$HOME/n"; [[ :$PATH: == ":$N_PREFIX/bin:" ]] || PATH+=":$N_PREFIX/bin" # Added by n-install (see http://git.io/n-install-repo).
</code></pre>
...
<pre><code>"export PATH = \" $ HOME / n / bin：$ PATH \" &amp;&amp;"
</code></pre>
