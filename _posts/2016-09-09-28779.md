...
<pre><code>&lt;video id="myvideo1" class="video-js" controls autoplay preload="none" onclick="this.play()" onplay="trackMoviePlay(1)" style="width: 100%;position: relative; height: 190px;" poster="&lt;?= $get_item["img"]; ?&gt;" data-setup="{}"&gt;
