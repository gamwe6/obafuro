...
<pre><code>SELECT o.custid, c.name, MAX(o.payment)
...
<pre><code>SELECT o.custid, o.name,o,address,MAX(o.payment)
  FROM orders AS o
  GROUP BY o.custid;
</code></pre>
...
<pre><code>SELECT o.custid, o.name,o.age,o.sex,MAX(o.payment)
  FROM orders AS o
