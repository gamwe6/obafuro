...
<pre><code>2019-09-05 03:31:05 +0000 [error]: #0 [match_api] failed to configure sub output s3: Unknown formatter plugin 'api_log'. Run 'gem search -rd fluent-pl
