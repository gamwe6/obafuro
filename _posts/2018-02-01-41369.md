...
<pre><code>alien -ci android-x86-6.0-r3.x86_64.rpm
</code></pre>

<p>上記環境で、</p>

<pre><code>cp /android-6.0-r3/system.sfs /tmp/
...
<pre><code># [ -d /proc/asound/card0 ] || modprobe snd-dummy
</code></pre>
...
<pre><code>adb -s x.x.x.x:5555 shell 'su root lsmod'
Module                  Size  Used by
snd_dummy              13393  0 
...
<pre><code>02-01 11:57:15.954  1088  1088 W audio_hw_primary: Unable to find the mixer
