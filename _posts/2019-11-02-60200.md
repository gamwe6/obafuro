...
<pre><code>236 function field_name_list()
237 {
...
<pre><code>206                 function nplurals_and_expression_from_header( $header ) {
...
<pre><code>73 &lt;?php if($meta_noindex==1 and $blog!=1){ ?&gt;
