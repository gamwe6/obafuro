...
<pre><code>ValueError:could not convert srtring to float'v -0.670323 0.017320 2.448769\nv -0.248426 0.066855 2.655411\nv -0.634120 0.159561 2.476978'
</code></pre>

<p>と出てしまい実行できません。<br>
xの方にはcsvの列指定をし、yの方には３次元配列の画像データを２次元配列に変換し指定して入れています。</p>

<pre><code>d_data_set = pd.read_csv("tes.csv", encoding="utf-8", dtype="object")
