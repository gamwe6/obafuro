...
<pre><code>&lt;% provide(:button_text, '保存') %&gt;
...
<pre><code>&lt;% provide(:button_text, '投稿') %&gt;
...
<pre><code>&lt;form novalidate="novalidate" class="simple_form edit_user" id="edit_user_1" action="/users/1" accept-charset="UTF-8" method="post"&gt;
