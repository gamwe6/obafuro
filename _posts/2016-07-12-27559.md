---
layout: post
title: CollectionViewをドラッグアンドドロップするためにUILongPressGestureRecognizerを設定したがロングプレスしても反応がない
date: 2016-07-12 06:46:49
categories: swift
---
<!-- {% raw %} -->
<p><a href="https://i.stack.imgur.com/rnvEJ.png" rel="nofollow noreferrer"><img src="https://i.stack.imgur.com/rnvEJ.png" alt="画像の説明をここに入力"></a>カスタムセルをのコレクションビューをドラッグアンドドロップするコードを書きました。<br>
Swiftのバージョンは2.2です。</p>

<p>やりたいこととしては、ナビゲーションバーの<code>editButton</code>を押してから、セルを長押してドラッグアンドドロップしてセルの配列を変更するというものです。</p>

<p>しかしながら、ビルドは通るものの、セルを長押ししても何も反応しませんし動きません。</p>
...
<p>　　　　　func LongGesture(sender: UILongPressGestureRecognizer) {<br>
        print("LongPressed")</p>
