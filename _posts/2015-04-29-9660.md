...
<pre><code> &lt;%= f.text_field :user_name, autofocus: true, class: "form-control login-field",placeholder: "ユーザネーム",id: "login-name" %&gt;
      &lt;/div&gt;
</code></pre>
...
<pre><code> validates :user_name, presence: true, uniqueness: true
