...
<pre><code>ActionController::UnknownFormat (SearchsController#index is missing a template for this request format and variant.
...
<pre><code>rails g model Search name:string
rake db:migrate
</code></pre>
...
<pre><code>&lt;%= form_tag searchs_path, :method =&gt; 'get' do %&gt; 
                      &lt;p&gt;
