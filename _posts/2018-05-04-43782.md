...
<pre><code>value loginName is not a member of play.api.data.Form[com.github.j5ik2o.spetstore.application.controller.LoginCustomer]
</code></pre>
...
<pre><code>case class LoginCustomer ( 
     email: string
     loginName: string
     password: string
)
...
<pre><code>def toprofpics(loginForm: LoginCustomer): Unit = ProfpicsUploadController.toprofpics(loginForm)
</code></pre>
...
<pre><code>package com.github.j5ik2o.spetstore.application.controller
