...
<pre><code>例：GetSplitData("AAA BBB", "\s+", "", "")// inData, delimiter, front, behind
戻り値→inData = "AAA BBB"
      front = "AAA"
      delimiter = " "
      behind = "BBB"
...
<pre><code>例：GetSplitData("AAA00BBB0000CCC", "[0-9]+", "", "")
...
<pre><code>public bool GetSplitData(string inData, string delimiter, ref string front, ref string behind)
{
    // 区切文字は後ろから検索する
