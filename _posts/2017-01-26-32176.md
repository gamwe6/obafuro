...
<pre><code>feature 'Navigation links for users', :devise do
...
<pre><code>def signin(email, password)
...
<pre><code>Capybara::Poltergeist::MouseEventFailed: Firing a click at co-ordinates [411.5, 321] failed. Poltergeist detected another element with CSS selector 'html body main div.authform form#new_user.new_user' at this position. It may be overlapping the element you are trying to interact with. If you don't care about overlapping elements, try using node.trigger('click').
</code></pre>
