...
<pre><code>gocsv.MarshalString(&amp;client)
</code></pre>
...
<pre><code>func convertCsvStringFromStruct(model interface{}) string {
   //共通処理
...
<pre><code>cannot use interface {}, only struct supported
</code></pre>

<p>このエラーが出る原因はライブラリで以下のように記述している部分があるためです</p>

<pre><code>func ensureInInnerType(outInnerType reflect.Type) error {
