...
<pre><code>GameObject cap = Instantiate(CapsulePrefab, new Vector3(0,0,0), transform.rotation) as GameObject;
</code></pre>
...
<pre><code>GameObject obj = Instantiate (prefab, new Vector3(0,0,0), transform.rotation) as GameObject;
