...
<pre><code>curl -L "https://raw.githubusercontent.com/rancher/k3s/master/docker-compose.yml" -o docker-compose.yml
...
<pre><code>Error: 'dial tcp 10.42.1.3:8443: connect: connection refused'
