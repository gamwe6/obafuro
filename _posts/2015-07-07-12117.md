...
<pre><code>self.kodawari_label.text = ary_name_kodawari?.componentsJoinedByString(" ")
...
<pre><code>let size:CGSize = self.kodawari_label.text!.sizeWithAttributes([NSFontAttributeName:font])
</code></pre>
