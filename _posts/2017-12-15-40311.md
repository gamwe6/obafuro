...
<pre><code>stringJSONRDD = sc.parallelize((""" 
{ "id": "123",
    "name": "Katie",
    "age": 19,
    "eyeColor": "brown"
...
<pre><code>swimmersJSON = spark.read.json(stringJSONRDD)
</code></pre>

<p>でDataFrameに変換した後．</p>

<pre><code>spark.sql("select*from swimmersJSON").collect()
</code></pre>
...
<pre><code>spark.sql("show databases").show
</code></pre>

<p>では</p>

<pre><code>&lt;bound method DataFrame.show of DataFrame[databaseName: string]&gt;
</code></pre>
