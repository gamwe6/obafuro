...
<pre><code># yum install http://repo.zabbix.com/zabbix/3.0/rhel/7/x86_64/zabbix-release-3.0-1.el7.noarch.rpm
</code></pre>

<p>・Zabbix関連のパッケージをインストール</p>

<pre><code>yum install zabbix-server-mysql zabbix-web-mysql zabbix-web-japanese zabbix-agent
</code></pre>

<p>しかし、テーブルを作成して初期データを登録しようとしたところ、</p>

<pre><code># zcat /usr/share/doc/zabbix-server-mysql-3.0.0/create.sql.gz | mysql -uroot zabbix
</code></pre>
