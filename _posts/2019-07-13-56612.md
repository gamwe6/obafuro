...
<pre><code>// サイズ1の新しい次元の導入によるテンソルのランクの増大
...
<pre><code>g++ -std=c++14 -I (path to Eigen) eigen_practice.cpp -o eigen_practice
</code></pre>
...
<pre><code>In file included from eigen_practice.cpp:12:
