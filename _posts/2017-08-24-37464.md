...
<pre><code>$ cd /usr/lib64/httpd/modules
$ ls -la
...
<pre><code># sudo /etc/rc.d/init.d/httpd24-httpd start
...
<pre><code>export PATH=/opt/remi/php70/root/usr/bin:/opt/remi/php70/root/usr/sbin${PATH:+:${PATH}}
