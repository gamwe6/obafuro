...
<pre><code>let options = PHImageRequestOptions()
...
<pre><code>infoOptional([PHImageResultIsDegradedKey: 0, PHImageResultWantedImageFormatKey: 5003, PHImageFileOrientationKey: 0, PHImageResultDeliveredImageFormatKey: 5003])
</code></pre>

<p>uiimageがnilになる時は、以下のようになります。</p>

<pre><code>infoOptional([PHImageResultIsDegradedKey: 0, PHImageResultWantedImageFormatKey: 5003, PHImageResultIsPlaceholderKey: 0, PHImageResultIsInCloudKey: 0, PHImageResultDeliveredImageFormatKey: 0])
</code></pre>

<p>や、</p>

<pre><code>([PHImageResultDeliveredImageFormatKey: 5003, PHImageResultIsDegradedKey: 0, PHImageResultWantedImageFormatKey: 5003])
</code></pre>
