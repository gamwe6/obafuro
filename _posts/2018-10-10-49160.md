...
<pre><code>' Lists the available plotters (plot configuration [PC3] files)
...
<pre><code>&lt;CommandMethod("PlotterLocalMediaNameList")&gt; _
...
<pre><code>GrxCAD.Runtime.Exception: eInvalidInput (code : 5)
