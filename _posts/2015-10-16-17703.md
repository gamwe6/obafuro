...
<pre><code>print(realmPath)
</code></pre>

<p>では</p>

<pre><code>/private/var/mobile/Containers/Shared/AppGroup/****-****--****/test.realm  
</code></pre>

<p>となりますが・・・</p>

<pre><code>let realm = try! Realm(path: realmPath)
</code></pre>

<p>のところで、</p>

<pre><code>2015-10-16 08:58:46.720 Test-Keyboard[8880:557651] ***storageTaskManagerExistsWithIdentifier:withIdentifier failed: Error Domain=NSCocoaErrorDomain Code=4099 "The connection to service named com.apple.nsurlstorage-cache was invalidated." UserInfo={NSDebugDescription=The connection to service named com.apple.nsurlstorage-cache was invalidated.}; {
...
<pre><code>func createPath() -&gt; String {
