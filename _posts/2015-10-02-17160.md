...
<pre><code>$(element).css('transform', 'translate(xpx, ypx)');
</code></pre>

<p>もしくは</p>

<pre><code>$(element).css('-webkit-transform', 'translate(xpx, ypx)');
</code></pre>

<p>と指定すると、</p>

<pre><code>$(element)[0].style.transform
$(element)[0].style.webkitTransform
</code></pre>

<p>で値が文字列で取得できる。</p>

<pre><code>$(element).css('transform')
