...
<pre><code>&gt;class MultipartFormData takes type parameters
</code></pre>
...
<pre><code>  type FilePartHandler[A] = FileInfo =&gt; Accumulator[ByteString, FilePart[A]]
...
<pre><code>@(user: models.User, picName: MultipartFormData, fileOption: Option[Long])(implicit request: RequestHeader, messages: Messages, webJarAssets: WebJarAssets)
