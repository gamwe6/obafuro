...
<pre><code>Error: SQLSTATE[23000]: Integrity constraint violation: 1048 Column 'role' cannot be null
</code></pre>
...
<pre><code>&lt;nav class="large-3 medium-4 columns" id="actions-sidebar"&gt;
    &lt;ul class="side-nav"&gt;
