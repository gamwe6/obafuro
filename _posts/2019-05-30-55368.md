...
<pre><code>ld: bitcode bundle could not be generated because 'フレームワークのパス' was built without full bitcode. All frameworks and dylibs for bitcode must be generated from Xcode Archive or Install build file 'フレームワークのパス' for architecture arm64
