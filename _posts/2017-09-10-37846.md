...
<pre><code>&lt;select name="custom_type_selector" id="custom_type_selector" class="wpallimport-post-types"&gt;
...
<pre><code>s1 = Select(browser.find_element_by_id('custom_type_selector'))
...
<pre><code>s1 = browser.find_element_by_xpath("//div[@class='wpallimport-choose-import-direction']/select/option[@value='post']")
...
<pre><code>s1 = browser.find_element_by_id('custom_type_selector')
...
<pre><code>driver.get("http://the-internet.herokuapp.com/dropdown")
