...
---
<!-- {% raw %} -->
<pre><code>ROLE_ARN=$(aws iam create-role \
      --role-name test \
...
<pre><code>An error occurred (InvalidParameterValueException) when calling the CreateFunction operation: The role defined for the function cannot be assumed by Lambda.
</code></pre>
