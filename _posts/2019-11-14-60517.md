...
<pre><code>[TaggedDocument(words=['過剰', '装飾', '重視', '考慮', '新しい', 'レンズ', 'フレーム', '関係', '出来', '軽量', '掛け', '心地', '技術', '反映', '真面目', '眼鏡', '印象', '受ける', 'フレーム', '視界', '妨げ', 'サイドリブ', '特徴', '外観', '生かし', '美しい', '形体', '眼鏡', 'フレーム', '新しい', '印象', '生み出し'], tags=['1'])]
