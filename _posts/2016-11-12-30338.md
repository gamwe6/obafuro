...
<pre><code>性別,"職業 (1=学生, 2=勤めてる, 3=主婦)",年齢,年収,利用可能なお金,購入日,購入時間帯,前に閲覧していた商品id,"季節(0=春, 1=夏, 2=秋, 3=冬)",地域 (JIS),購入時付与ポイント,屋外温度,"気候(0=晴れ, 1=くもり, 2=雨)",ドル円(外為),ユーロ円(外為),送料,"知った方法(1=ネット検索, 2=口コミ)","趣味(1=インドア, 2=アウトドア)","流入元(0=スマフォ, 1=PC, 2=実店舗)"
...
<pre><code>1,3,23,400,3000000,1456758000,79200,2,0,1,0.03,16,1,103,103,0,1,1,0
</code></pre>
