...
<pre><code>|Weight(g)|Long axis|Short axis|Grain thickness|Sumple_vert|BeanNumber_vert|
|:--|:--:|--:|--:|--:|--:|
...
<pre><code>                     Weight(g)  Long axis  Short axis  Grain thickness
...
<pre><code>Basedata=df.groupby('BeanNumber_vert')
