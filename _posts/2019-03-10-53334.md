...
date: 2019-03-10 07:10:20
categories: python3
---
<!-- {% raw %} -->
<p><a href="https://github.com/karaage0703/TextGenerator" rel="nofollow noreferrer">https://github.com/karaage0703/TextGenerator</a> を参考にし、PrepareChain.pyを起動させたところ次のようなエラーが出ました。</p>

<pre><code>C:\Users\Desktop&gt;python PrepareChain.py sample.txt
...
python3.6.5<br>
windows10<br>
です。72行目に修正箇所があるということなのでしょうか。</p>

<p>以下PrepareChain.pyの中身です。</p>
