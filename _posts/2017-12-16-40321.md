...
<pre><code>All com.android.support libraries must use the exact same version specification (mixing versions can lead to runtime crashes). Found versions 27.0.1, 26.1.0. Examples include com.android.support:customtabs:27.0.1 and com.android.support:animated-vector-drawable:26.1.0 less... (⌘F1) 
