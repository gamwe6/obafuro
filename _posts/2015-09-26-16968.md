...
<pre><code>&lt;form method="POST" id="image-form" enctype="multipart/form-data"&gt;
...
<pre><code>@RequestMapping(value = "/addImage", method = RequestMethod.POST)
@ResponseBody
...
<pre><code>$('#imageFile').prop('files')[0].name;
</code></pre>
