...
<pre><code>Script attached to 'Boar_walk2' in scene 'Assets/Scenes/nengajou2019.unity' is missing or no valid script is attached.
UnityEngine.GUIUtility:ProcessEvent(Int32, IntPtr)
...
<pre><code>DirectoryNotFoundException: Could not find a part of the path "/Users/ユーザー名/New Unity Project (2)/Temp/StagingArea/Trampoline/Unity-iPhone.xcodeproj/project.pbxproj".
