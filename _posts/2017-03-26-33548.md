...
<pre><code> class ChangePasswordViewController: UIViewController,UITableViewDelegate, UITableViewDataSource {
...
<pre><code>class ChangePasswordTableViewCell: UITableViewCell {
