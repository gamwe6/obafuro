...
<pre><code>TypeError: tab.setActiveCarouselItemIndex is not a function
</code></pre>
...
<pre><code>&lt;ons-carousel var="tab" swipeable auto-scroll ng-style="tabHeight"&gt;
...
<pre><code>$scope.changeTab = function(index) {
