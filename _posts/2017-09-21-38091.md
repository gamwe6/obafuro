...
<pre><code>exception in initAndListen: 10309 Unable to create/open lock file: /data/db/mongod.lock errno:13 Permission denied Is a mongod instance already running?, terminating
</code></pre>

<p>sudo mongodで実行して見たら今度はこのようなエラーが出て来ました。<br>
1回目</p>

<pre><code>Fri Sep 22 01:54:50.756 [initandlisten] ERROR: listen(): bind() failed errno:98 Address already in use for socket: 0.0.0.0:27017
...
<pre><code>Fri Sep 22 14:21:52.944 [initandlisten] db version v2.4.9
...
<pre><code>Fri Sep 22 15:30:51.327 [websvr] admin web console waiting for connections on port 28017
...
<pre><code>sudo chown ユーザ名:ユーザ名 -R /data/db/
</code></pre>
...
<pre><code>chown: invalid user: ‘mongod:mongod’
</code></pre>
...
<pre><code>Thu Sep 21 09:38:02.621 [initandlisten] MongoDB starting : pid=1046 port=27017 dbpath=/var/lib/mongodb 32-bit host=vagrant-ubuntu-trusty-32
