...
<pre><code>let data = try PropertyListEncoder().encode(animals)
</code></pre>

<p>で、デコードは</p>

<pre><code>let animals2 = try PropertyListDecoder().decode([Animal].self, from: data)
</code></pre>
