...
<pre><code>int maxDoubleArray(int a[],int size) {...}
</code></pre>

<p>の箇所を</p>

<pre><code>double maxDoubleArray(double a[],int size) {...}
</code></pre>

<p>と直したのですが、以下のようなエラーが出てしまいました。</p>

<blockquote>
<pre><code>format ‘%lf’ expects argument of type ‘double *’, but argument 2 has
