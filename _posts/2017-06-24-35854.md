...
<pre><code>let image = ["A.jpg", "B.jpg", "C.jpg", "D.jpg"] //ここでは4つの画像ファイルを用意しております。
</code></pre>

<p>・上記画像データに対するタグ</p>

<pre><code>let tag = ["A", "B", "A", "A"]　//「A.jpg」のタグは「A」となります。
</code></pre>

<p>・上記画像データに対する日付</p>

<pre><code>let date = ["2016/06/25", "2016/06/24", "2016/06/23", "2016/06/22"] //「A.jpg」の日付は「2016/06/25」となります。
</code></pre>
