---
layout: post
title: 追従する文字列を、"ボタン"ではなくてただクリックするだけで"切り離し⇔追従"とする方法
date: 2017-04-23 06:14:47
categories: javascript
---
<!-- {% raw %} -->
<p>最近、追従する文字列をクリックするたびに"切り離し⇔追従"とする面白いコードをいただき、<br>
これをヒントに別コードで"ボタン"をクリックするたびに"切り離し⇔追従"とするコードを作りました。<br>
これを、"ボタン"ではなくて、いただいたコードのようにただ"クリック"するだけで"切り離し⇔追従"とするコードに作り変えられないでしょうか。可能でしたら、教えていただけないでしょうか。<br>
関連箇所は、スクリプトの"function onoff(){}"あたりです。</p>
