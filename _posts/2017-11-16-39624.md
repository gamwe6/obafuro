...
<pre><code>&lt;table id="kategoriTanka" class="table table-bordered table-hover table-striped center-all"&gt;
  &lt;thead&gt;
    &lt;tr&gt;
...
<pre><code>      $('#tbl').on('processing.dt', function (e, settings, processing) {
