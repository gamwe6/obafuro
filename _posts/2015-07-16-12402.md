...
<pre><code>public class MainInit implements ActionListener , WindowListener {        //impriments(組み込む)
...
<pre><code>public class ItemBox extends JPanel  implements ActionListener{        //ItemBoxはJPanelというオブジェクトクラスを継承
