...
<pre><code>var app = angular.module('myApp', ['onsen' , 'twitterApp.services']);
</code></pre>

<p>controller.js</p>

<pre><code>app.controller('TwitterController', function($scope, $q, twitterService) {
...
<pre><code>angular.module('twitterApp.services', []).factory('twitterService', function($q) {
