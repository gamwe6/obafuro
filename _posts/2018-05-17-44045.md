...
<pre><code>-- DROP TABLE IF EXISTS `customer1`;
...
<pre><code>include "silhouette.conf"
...
<pre><code>    def insert(data: Data): Unit = SignUpFormSupport.insert(data)
}
</code></pre>
...
<pre><code>  import forms.SignUpForm._
  // dbへのinsert
...
<pre><code>        val email2 = email.toString
...
<pre><code>[info] application - Creating Pool for datasource 'default'
