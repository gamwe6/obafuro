...
<pre><code>   Couldn't create database for {"adapter"=&gt;"postgresql", "pool"=&gt;5, "timeout"=&gt;5000, "host"=&gt;"localhost", "database"=&gt;"db/test.pg"}
rake aborted!
...
<pre><code>4     0  2395  1313  20   0  96080  3816 unix_s Ss   ?          0:00 sshd: vagrant [priv]
