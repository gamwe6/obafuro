...
<pre><code>    Private Sub SetFrontClipOnOf(ByVal blnEnabled As Boolean)
...
<pre><code>        Public Sub ZoomRangeByAcView(CenPnt As Point3d, icdDoc As Document, ByVal dblRad As Double)
