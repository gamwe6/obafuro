...
<pre><code>    private func setJsonDataListByType(jsonList : NSArray) -&gt; Array&lt;String&gt; {
...
<pre><code>Cannot subscript a value of type 'Element' (aka 'AnyObject') with an index of type 'String'
</code></pre>
