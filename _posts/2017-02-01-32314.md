...
<pre><code>internal override func initialize()
{
    super.initialize()
...
<pre><code>open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
...
<pre><code>    renderer = RadarChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
</code></pre>
