---
layout: post
title: グリッドレイアウトに登録したカードパネルの切り替えについて
date: 2019-07-23 12:46:41
categories: java
---
<p>グリッドレイアウトの一部に、演算用のカードレイアウトを4枚（+-*/）登録し、別のグリッドレイアウトに登録した演算切り替えのラジオボタンで、演算用のカードレイアウトを切り替えたいのですが、切り替えがうまく出来ません。切り替え表示以外の動作は問題なく出来ています。切り替え表示がうまくいかない原因がわからず詰まっている状態です。</p>

<pre><code>package lec0402;
