...
<pre><code>WORKDIR /usr/local/lib/mecab/dic
...
<pre><code>RUN .bin/install-mecab-ipadic-neologd -n -a
</code></pre>

<p>で</p>

<pre><code>/bin/sh: .bin/install-mecab-ipadic-neologd: No such file or directory
</code></pre>
...
<pre><code>Step 59/67 : RUN yum -y install xz
 ---&gt; Using cache
 ---&gt; e36c255a6c4f
