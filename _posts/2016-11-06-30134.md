...
<pre><code>let json: NSDictionary = try JSONSerialization.jsonObject(with: data!, options: .allowFragments) as! NSDictionary
</code></pre>

<p>の部分で</p>

<pre><code>The data couldn’t be read because it isn’t in the correct format.
</code></pre>
