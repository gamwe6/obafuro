...
categories: swift
---
<pre><code>value of optional type 'String?' not unwrapped; did you mean to use '!' or '?'?
</code></pre>
...
<pre><code>let text = searchBar.text.stringByAddingPercentEncodingWithAllowedCharacters(NSCharacterSet.URLQueryAllowedCharacterSet())
</code></pre>
