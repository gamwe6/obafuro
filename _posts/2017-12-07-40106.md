...
<pre><code>if (isset($_POST["logoffbtn"])){
        session_destroy();
...
<pre><code>&lt;form method="post" action="sortex.php"&gt;
    &lt;h1&gt;
        &lt;div&gt;
            &lt;span id="auto"&gt;&lt;/span&gt;
...
<pre><code>$(".logoffbtn").on("click",function() {
    $(this).val("*");
    return false;
});
</code></pre>
...
<pre><code>if (isset($_POST["logoffbtn"]) || isset($_POST["logoffbtn_x"]) || isset($_POST["logoffbtn_y"])){
//  session_destroy();
    header("location: logon.php");
    exit;
}
