...
<pre><code>pandoc docs/doc1.md -o doc1.pdf -V documentclass=ltjarticle --latex-engine=lualatex
</code></pre>

<p>すると、下記のエラーが発生してしまいます。</p>

<pre><code>pandoc.exe: Could not find image `../images/test.png', skipping...
</code></pre>
