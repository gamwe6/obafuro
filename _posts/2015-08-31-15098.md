...
<pre><code> String driver   = "org.gjt.mm.mysql.Driver";
...
<pre><code>export CLASSPATH=$CLASSPATH:/usr/local/apache-tomcat-8.0.26/lib/mysql-connector-java-5.1.17.jar
</code></pre>

<p>また、Tomcatを再起動した際、以下のように表示されます。</p>

<pre><code>Starting tomcat: Using CATALINA_BASE:   /usr/local/apache-tomcat-8.0.26
