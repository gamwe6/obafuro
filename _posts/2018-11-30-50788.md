...
<pre><code>_tabAViewController = [[AViewController alloc]initmake];
...
<pre><code>@interface ListView : BaseTableView &lt;UITableViewDelegate, UITableViewDataSource&gt; {
}
