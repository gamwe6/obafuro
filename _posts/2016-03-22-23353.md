...
<pre><code>func BenchmarkEdge(b *testing.B) {
    m := GetMatrix(480, 360)
    for i := 0; i &lt; b.N; i++ {
        err := m.Pad(7, Edge)
        if err != nil {
...
<pre><code>go test -cpu 4 -bench . -benchmem
</code></pre>
...
<pre><code>BenchmarkEdge-4      100      11697971 ns/op    12066503 B/op       1198 allocs/op
</code></pre>

<p><strong>goroutineあり</strong></p>

<pre><code>BenchmarkEdge-4      200      18919942 ns/op    33900980 B/op       1901 allocs/op
</code></pre>
