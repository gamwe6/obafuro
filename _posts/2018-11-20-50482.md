...
<pre><code>class Autoencoder(Chain):
    def __init__(self):
       super().__init__()
...
<pre><code>Exception in main training loop: Unsupported type &lt;class 'NoneType'&gt;
...
<pre><code>    updater = training.StandardUpdater(train_iter,optimizer,device=-1)
</code></pre>

<p>としてみたら今度は、</p>

<pre><code>    Exception in main training loop: unsupported operand type(s) for *: 'bool' and 'NoneType'
Traceback (most recent call last):
  File "/home/****/.local/lib/python3.5/site-packages/chainer/training/trainer.py", line 308, in run
    update()
  File "/home/****/.local/lib/python3.5/site-packages/chainer/training/updaters/standard_updater.py", line 149, in update
