...
<pre><code>curl -X POST -H "X-Metabase-Session:METABASE_SESSION_TOKEN" -d '{"parameters": {parameter:value}}' URL/api/card/:card-id/query/json
</code></pre>
...
<pre><code>2019-10-17T02:55:31.228416+00:00 ***[router]: at=info method=POST path="/callback" host=URL request_id=METABASE_SESSION_TOKEN fwd=IP dyno=web.1 connect=0ms service=4519ms status=500 bytes=455 protocol=https
</code></pre>
