...
<pre><code>Alamofire.request(.GET,requestUrl).responseJSON {(request, response, json, error) in
...
<pre><code>'(_, _, _, _) -&gt; Void' is not convertible to 'Response&lt;AnyObject, NSError&gt; -&gt; Void'
</code></pre>
