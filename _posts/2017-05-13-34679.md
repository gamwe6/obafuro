...
<pre><code>curl -s -k -H "Content-Type: application/json" -H "Authorization: Bearer アクセストークンの文字列" https://speech.googleapis.com/v1beta1/speech:syncrecognize -d @sync-request.json
</code></pre>
