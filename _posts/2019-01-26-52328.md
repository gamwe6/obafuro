...
<pre><code>select sample0_."__id" as __id_1_7_, sample0_."year" as year2_7_ from sample sample0_
</code></pre>

<p><strong>パターン2: @Queryを使用しnativequeryを記述(正常に動作)</strong></p>

<pre><code>@Query("select \"__id\" as id, \"year\" from sample", nativeQuery = true)
</code></pre>

<p>出力されたSQL</p>

<pre><code>select "__id" as id, "year" from sample
</code></pre>
