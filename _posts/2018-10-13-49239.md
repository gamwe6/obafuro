...
<pre><code>var emailMessage = new MimeMessage ();
...
<pre><code>MailKit.Security.AuthenticationException: AuthenticationMechanismTooWeak: 5.7.14 &lt;https://accounts.google.com/signin/continue?sarp=1&amp;scc=1&amp;plt=AKgn
sbuI
