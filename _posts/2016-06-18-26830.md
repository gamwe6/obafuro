...
<pre><code>You called `set_weights(weights)` on layer "convolution2d_1" with a  weight list of length 32, but the layer was expecting 2 weights.
</code></pre>

<p><strong>コード</strong></p>

<pre><code>def LoadModel(path, input_shape):
    params = None
