...
<pre><code>Could not bind to 127.0.0.1:9050: Address already in use. Is Tor already running?　
</code></pre>

<p><strong>確認結果</strong></p>

<pre><code>example@example:~$ sudo lsof -i:9050
...
<pre><code>example@example:~$ sudo kill 4031
example@example:~$ tor
