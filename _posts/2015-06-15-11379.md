...
<pre><code>Flat UI HTML - Developers License/HTML/UI/Flat-UI-Pro-1.3.2
</code></pre>
...
<pre><code>maimai-no-MacBook-Air:ponpon maimai$ rails generate flatuipro:install ~/flat-ui-pro
