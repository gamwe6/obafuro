...
<pre><code>  index GET      /index(.:format)     public#index
...
<pre><code>class Chat &lt; ActiveRecord::Base
...
<pre><code>class PublicController &lt; ApplicationController
  def index
    @chat = Chat.new
  end
