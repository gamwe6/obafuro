...
<pre><code>[ContentProperty("DataTemplateTable")]
...
<pre><code>&lt;local:TypeToDataTemplateSelector x:Key="TypeToDataTemplateSelector"&gt;
...
<pre><code>&lt;DataTemplate x:Key="DataTemplateA" DataType="local:ViewModelA"&gt;
    &lt;TextBlock Text="ViewModelA"/&gt;
&lt;/DataTemplate&gt;
