...
<pre><code>product_id  plg_count   rank
11          6962271     1
10          2705517     2
379         1955067     3
378         196865      4
...
<pre><code>INSERT INTO dtb_ranking (`product_id`,`plg_count`,`rank`) VALUES (CALL `ranking_long`())ON DUPLICATE KEY UPDATE plg_count = NEW.plg_count, rank = NEW.rank; 
</code></pre>
...
<pre><code>INSERT INTO dtb_ranking (`product_id`,`plg_count`,`rank`) VALUES (CALL `ranking_long`()) ON DUPLICATE KEY UPDATE plg_count = VALUES(plg_count), rank = VALUES(rank);
</code></pre>
