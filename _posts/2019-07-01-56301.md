...
<pre><code>docker run --rm -v ${PWD}:/local openapitools/openapi-generator-cli generate \
...
<pre><code>$ docker run -it  --rm -v ${PWD}:/local openapitools/openapi-generator-cli /bin/bash
bash-4.3#                                                                                                                                                                                   
</code></pre>
...
<pre><code>bash-4.3# ls /opt/openapi-generator/modules/openapi-generator-cli/target/
