...
<pre><code>override func willAnimateRotationToInterfaceOrientation(toInterfaceOrientation: UIInterfaceOrientation, duration: NSTimeInterval) {
が効いていないような感じです。
</code></pre>

<p>解決方法ご存知の方はご教示お願いします。</p>

<pre><code>// 画面回転時に呼び出される
