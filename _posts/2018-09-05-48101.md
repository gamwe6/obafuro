...
<pre><code>Do Until (TextBox5.ForeColor = Color.Black) And (TextBox6.ForeColor = Color.Black) And (TextBox7.ForeColor = Color.Black) And (TextBox8.ForeColor = Color.Black)
            Timer1.Enabled = True
