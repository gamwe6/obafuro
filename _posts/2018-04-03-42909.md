...
<pre><code>curl --user "[私のユーザ名]:[私のアクセストークン]" -s https://api.github.com/orgs/[団体名]/members/[ユーザ名] -o /dev/null -w "%{http_code}\n"
</code></pre>
...
<pre><code>curl --user "[私のユーザ名]:[私のパスワード]" -s https://api.github.com/orgs/[団体名]/members/[私のユーザ名] -o /dev/null -w "%{http_code}\n"
</code></pre>
...
<pre><code>curl --user "[私のユーザ名]:[アクセストークン]" https://api.github.com/orgs/[団体名]/members
</code></pre>
