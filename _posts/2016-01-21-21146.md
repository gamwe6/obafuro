...
<pre><code>Intent { act=android.intent.action.MAIN cat=[android.intent.category.LAUNCHER] flg=0x10000000 cmp=com.example.sakaguchi/.MainActivity }</code></pre>
...
<pre><code>Intent { flg=0x4400000 cmp=com.example.sakaguchi/.MainActivity bnds=[0,363][1080,555] }</code></pre>
