...
<pre><code>ibswiftCore.dylib`function signature specialization &lt;preserving fragile attribute, Arg[2] = Dead, Arg[3] = Dead&gt; of Swift._fatalErrorMessage (Swift.StaticString, Swift.StaticString, Swift.StaticString, Swift.UInt, flags : Swift.UInt32) -&gt; Swift.Never:
...
<pre><code>//  ExtensionViewController.swift
...
<pre><code>Autolayout`ViewController.setPreviewLayer() -&gt; ():
