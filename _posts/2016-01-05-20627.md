...
<pre><code>&lt;Error&gt;: void CGPathAddCurveToPoint(CGMutablePathRef _Nullable, const CGAffineTransform * _Nullable, CGFloat, CGFloat, CGFloat, CGFloat, CGFloat, CGFloat): no current point.
</code></pre>
