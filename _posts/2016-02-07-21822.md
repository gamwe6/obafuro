...
<pre><code>&lt;ons-sliding-menu var="app.slidingMenu" menu-page="menu.html" main-page="home.html" side="left" type="overlay" max-slide-distance="200px"&gt;
</code></pre>
...
<pre><code>module.controller('ctrl_search.html', function($scope) {
  ons.ready(function() {
...
<pre><code>&lt;ons-navigator var="myNavigator"&gt;
...
<pre><code>&lt;ons-page ng-controller="ctrl_search.html"&gt;
  &lt;ons-toolbar&gt;...&lt;/ons-toolbar&gt;
  &lt;ul class="cs-ulh"&gt;&lt;/ul&gt;
&lt;/ons-page&gt;
</code></pre>
